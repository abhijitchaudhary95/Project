        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Banner {{ ($banner_data) ? 'Update' : 'Add' }}</h3>
                </div>
                        ...
                        <div class="x_content">
                            ...
                            @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="class col-sm-9">
                                        {{ Form::select('status',['active'=>'Active','inactive'=>'Inactive'],@$banner_data->status,['class'=>'form-control','required'=>true,'id'=>'status']) }}
                                        @error('status')
                                        <span class="alert-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col sm-4">
                                        @if($banner_data && $banner_data->image != "" && file_exists(public_path().'/uploads/banner/'.$banner_data->image))
                                            <img src="{{ asset('uploads/banner/'.$banner_data->image) }}" alt="" class="img img-responsive img-tumbnail">
                                        @endif
                                    </div>
                                </div>
